...
import group7.inventario.inventario.email.EmailSender;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request)
    {
        ...
        String link = "http://localhost:8080/user/registrar/confirm?token=" + token;
    ...
    private String buildEmail(String name, String link) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                ...
                "Gracias por registrarte. Haga clic en el enlace de abajo para activar su cuenta: </p><blockquote style=\"Margin:0 0 20px 0;border-left:10px solid #b1b4b6;padding:15px 0 0.1px 15px;font-size:19px;line-height:25px\"><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> <a href=\"" + link + "\">Activar Ahora</a> </p></blockquote>\n El enlace expira en 15 minutos. <p>See you soon</p>" +
                "        \n" +
                "      </td>\n" +
                "      <td width=\"10\" valign=\"middle\"><br></td>\n" +
                "    </tr>\n" +
